...
{
    public partial class thisinhdangnhap : Form
    {
        public thisinhdangnhap()
        {
            InitializeComponent();
        }


         public bool DDN = false;
         public string MSTS;
        ...
        private bool PK_TaiKhoan(string s)
        {
            con.Open();
            bool tatkt = true;
            SqlDataAdapter da_kiemtra = new SqlDataAdapter("Select * from dsthi where msts='" + s + "'", con);
